...
create_snphub_object <- function(snp_data, snp_summary, marker_status = NULL, output_dir = NULL,
...
snp_summary <- function(x, ...) {
	...
	cat("Median Heterozygousity (He):", median(x$allele_df$Nei_H, na.rm = TRUE), "\n")
